...
public class PopUpSiswa extends javax.swing.JFrame {
   ...
   int tabelSiswa = tblpopup.getSelectedRow(); 
        siswa.idsiswa = tblpopup.getValueAt   (tabelSiswa, 0).toString(); 
        siswa.nama = tblpopup.getValueAt   (tabelSiswa, 1).toString(); 
        siswa.jenis = tblpopup.getValueAt   (tabelSiswa, 2).toString(); 
        siswa.jurusan = tblpopup.getValueAt   (tabelSiswa, 3).toString(); 
        siswa.kelas = tblpopup.getValueAt   (tabelSiswa, 4).toString(); 
        siswa.telp = tblpopup.getValueAt   (tabelSiswa, 5).toString(); 
